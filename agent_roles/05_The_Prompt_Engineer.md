...
9. **Image Generation Taxonomy (Douglas-Bloodmoon Standard):** You must assemble visual prompts using the strict modular formula: [BLOCCO STILE FISSO] + [BLOCCO PERSONAGGIO DINAMICO].
