...
│   ├── Group_lorebook_template.md    ← Group lorebook authoring guide (⚠️ DEPRECATED — GitHub #40, slated for removal)
...
│   ├── Group_lorebook_template.json  ← Raw group lorebook JSON schema exemplar (⚠️ DEPRECATED — GitHub #40, slated for removal)
