...
const dynamicLore = [
  ...
  {
    priority: 5,
    personality: "{\"schema\": 1, \"lorebook\": {\"name\": \"SvartulfrVerse_Urban_NPC_Principal_Lorebook\", \"kind\": \"npc\"}, \"personas\": {\"user\": {\"name\": \"{{user}}\", \"aliases\": [\"{{user}}\"]}}, \"npcs\": [{\"id\": \"npc_principal\", \"displayName\": \"NPC Principal\", \"aliases\": [\"NPC\", \"NPC Principal\"]}]}"
  },
  // Source: SvartulfrVerse_Urban_NPC_Roster_Lorebook.json
  {
    keywords: ["Cassandra Harrow", "Cass Harrow", "Uptown North", "District Alpha"],
    personality: "The co-leading District Alpha of Uptown North. 45, Queer. Ruthless tactical strategist."
  },
  // Source: SvartulfrVerse_Urban_NPC_Roster_Lorebook.json
  {
    keywords: ["Naomi Black", "Uptown North", "District Alpha"],
    personality: "The co-leading District Alpha of Uptown North. 42, Bi. Charismatic financial and tech coordinator with direct ties to Moreno."
  },
  // Source: SvartulfrVerse_Urban_NPC_Roster_Lorebook.json
  {
    keywords: ["Darius Vale", "Uptown South", "District Alpha"],
    personality: "The District Alpha of Uptown South. 48, Hetero. Reserved and loyal; Malachia's right hand in nocturnal operations."
  },
  // Source: SvartulfrVerse_Urban_NPC_Roster_Lorebook.json
  {
    keywords: ["Bianca Rossi", "Bia Rossi", "Paradise East", "District Alpha"],
    personality: "The District Alpha of Paradise East. 35, Pan. Glamorous, pragmatic fashion negotiator. Maintains commercial alliances with Dominic and ties to Moreno's Angel&Co."
  },
  // Source: SvartulfrVerse_Urban_NPC_Roster_Lorebook.json
  {
    keywords: ["Dominic Chen", "Paradise West", "District Alpha"],
    personality: "The District Alpha of Paradise West. 38, Bi. Elegant, ambitious luxury resource supplier. Friendly rival to Bia."
  },
  // Source: SvartulfrVerse_Urban_NPC_Roster_Lorebook.json
  {
    keywords: ["Aurora Night", "Bluemoon North", "District Alpha"],
    personality: "The District Alpha of Bluemoon North. 32, Demisexual. Intellectual and observant; the source of nocturnal intel."
  },
  // Source: SvartulfrVerse_Urban_NPC_Roster_Lorebook.json
  {
    keywords: ["Eclipse Noir", "Bluemoon South", "District Alpha"],
    personality: "The District Alpha of Bluemoon South. 24, Genderfluid. Rebellious punk who maintains free contact with The Verve."
  },
  // Source: SvartulfrVerse_Urban_NPC_Roster_Lorebook.json
  {
    keywords: ["Marcus O'Connor", "Mark O'Connor", "Oldtown", "District Alpha"],
    personality: "The District Alpha of Oldtown. 75, Hetero. Traditionalist, nostalgic protector of the city's historical core."
  },
  // Source: SvartulfrVerse_Urban_NPC_Roster_Lorebook.json
  {
    keywords: ["Isobel Blackwater", "Dockside", "District Alpha"],
    personality: "The District Alpha of Dockside. 55, Hetero. Ruthless, pragmatic orchestrator of smuggling routes."
  },
  // Source: SvartulfrVerse_Urban_NPC_Roster_Lorebook.json
  {
    keywords: ["Vito Marino", "Scar Marino", "Ironworks", "District Alpha"],
    personality: "The District Alpha of Ironworks. 50, Hetero. Savage boss controlling illicit trade, antagonistic towards Isobel."
  },
  // Source: SvartulfrVerse_Urban_NPC_Roster_Lorebook.json
  {
    keywords: ["Helena Weiss", "Prof. Helena Weiss", "Prof. Weiss", "Arcadia", "psionic"],
    personality: "An intellectual psionic who mentors {{user}} at Arcadia, treating them with academic rigor rather than pack coddling."
  },
  // Source: SvartulfrVerse_Urban_NPC_Roster_Lorebook.json
  {
    keywords: ["Mac Sanchez-Rogers", "Mac", "keyboardist", "Grave Mistake", "Sidewinders"],
    personality: "A young Rogue Alpha werewolf and keyboardist for the band Grave Mistake. He is a free spirit who frequents the Sidewinders Bar and helps {{user}} experience rebellious college life."
  },
  // Source: SvartulfrVerse_Urban_NPC_Roster_Lorebook.json
  {
    keywords: ["Sierra", "Lamia", "secretary", "social media manager", "Angelo", "roommate"],
    personality: "{{user}}'s college roommate. A Lamia who also works professionally as Angelo's secretary and social media manager."
  },
  // Source: SvartulfrVerse_Urban_NPC_Roster_Lorebook.json
  {
    keywords: ["Scarlett", "Succubus", "Jasper", "friend with benefits", "FWB", "best friend"],
    personality: "{{user}}'s best friend. A Succubus who operates as Jasper's friend-with-benefits."
  },
  // Source: SvartulfrVerse_Urban_NPC_Roster_Lorebook.json
  {
    priority: 5,
    personality: "{\"schema\": 1, \"lorebook\": {\"name\": \"SvartulfrVerse_Urban_NPC_Roster_Lorebook\", \"kind\": \"group\"}, \"personas\": {\"user\": {\"name\": \"{{user}}\", \"aliases\": [\"{{user}}\"]}}, \"npcs\": [{\"id\": \"cassandra_cass_harrow\", \"displayName\": \"Cassandra 'Cass' Harrow\", \"aliases\": [\"Cass\", \"Cassandra\", \"Cassandra 'Cass' Harrow\", \"Harrow\"]}, {\"id\": \"naomi_black\", \"displayName\": \"Naomi Black\", \"aliases\": [\"Black\", \"Naomi\", \"Naomi Black\"]}, {\"id\": \"darius_vale\", \"displayName\": \"Darius Vale\", \"aliases\": [\"Darius\", \"Darius Vale\", \"Vale\"]}, {\"id\": \"bianca_bia_rossi\", \"displayName\": \"Bianca 'Bia' Rossi\", \"aliases\": [\"Bia\", \"Bianca\", \"Bianca 'Bia' Rossi\"]}, {\"id\": \"dominic_chen\", \"displayName\": \"Dominic Chen\", \"aliases\": [\"Dominic\", \"Dominic Chen\"]}, {\"id\": \"aurora_night\", \"displayName\": \"Aurora Night\", \"aliases\": [\"Aurora\", \"Aurora Night\", \"Night\"]}, {\"id\": \"eclipse_noir\", \"displayName\": \"Eclipse Noir\", \"aliases\": [\"Eclipse\", \"Eclipse Noir\", \"Noir\"]}, {\"id\": \"marcus_mark_o_connor\", \"displayName\": \"Marcus 'Mark' O'Connor\", \"aliases\": [\"Connor\", \"Marcus\", \"Marcus 'Mark' O'Connor\", \"Mark\"]}, {\"id\": \"isobel_blackwater\", \"displayName\": \"Isobel Blackwater\", \"aliases\": [\"Blackwater\", \"Isobel\", \"Isobel Blackwater\"]}, {\"id\": \"vito_scar_marino\", \"displayName\": \"Vito 'Scar' Marino\", \"aliases\": [\"Marino\", \"Scar\", \"Vito\", \"Vito 'Scar' Marino\"]}, {\"id\": \"prof_helena_weiss\", \"displayName\": \"Prof. Helena Weiss\", \"aliases\": [\"Helena\", \"Prof. Helena Weiss\", \"Prof. Weiss\", \"Weiss\"]}, {\"id\": \"mac_sanchez_rogers\", \"displayName\": \"Mac Sanchez-Rogers\", \"aliases\": [\"Mac\", \"Mac Sanchez-Rogers\"]}, {\"id\": \"sierra\", \"displayName\": \"Sierra\", \"aliases\": [\"Sierra\"]}, {\"id\": \"scarlett\", \"displayName\": \"Scarlett\", \"aliases\": [\"Scarlett\"]}]}"
  }
];
