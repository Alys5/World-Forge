...
---]`
	...
	{
		keywords: ['γ gamma — pre-presentation state'],
		priority: 4,
...
*Cross-references: [LSE_00_Foundations.md](LSE_00_Foundations.md) · [LSE_02_Behavioral_Ecology.md](LSE_02_Behavioral_Ecology.md) · [LSE_06_History.md](LSE_06_History.md) · [LSE_07_Foundational_Figures.md](LSE_07_Foundational_Figures.md)*]`
	...
	{
		keywords: ['character card integration (parameter block)'],
		priority: 4,
...
↳ Effect: [Effect]]`
	...
	},
	{
		tag: "wiki_auto_52",
		priority: 5,
		scenario: ` [WIKI - CONCEPT: **STARTING OUTFIT**\n\nStyle Guidelines: [General style]
...
Underwear: [Underwear]]`
	...
	},
	{
		tag: "wiki_auto_53",
		priority: 5,
		scenario: ` [WIKI - CONCEPT: **INVENTORY**\n\nItem: [Item Name]
↳ Details: [Details]]`
	},
