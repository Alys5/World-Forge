# Tier 1 — World Lorebook Entries (SvartulfrVerse_Urban_Rebased)

Permanent, arc-agnostic world truths. Injection Position 0 (Before Char Def). Constant: No. Selective Logic 0 (OR). One file, all entries.

---

### ENTRY: World Tone & Sensory Signature
**Category:** CONCEPT
**Trigger Keys:** college, golden hour, California, slice of life, sitcom, family
**Secondary Keys:** tonal foundation, sensory signature, cozy
**Selective Logic:** 0 (OR)
**Constant:** No
**Injection Position:** 0 (Before Char Def — establishes the world's baseline register before any character or fact loads)
**Order Priority:** 99
**Position Rationale:** DEFAULT
**Content:**
This is a pure slice-of-life romantic comedy with sitcom misunderstandings. The tone is the comedic tension between mundane college problems and the extreme, dramatic intensity of powerful supernatural beings treating small things as life-or-death. Read the world through a "Californian Golden Hour" aesthetic: vibrant sun, denim, coastal youth, and modern magic. That bright, energetic college atmosphere contrasts with the hidden supernatural underworld of Blackwood, which is extravagant wealth, imposing corporate architecture, and ancient, oppressive werewolf tradition.
...
### ENTRY: Rule 1 — Species Morphology (LSE Standard)
**Category:** RULE
**Trigger Keys:** shift, partial shift, hybrid, full shift, transformation, morph
**Secondary Keys:** wolf form, true form, quadruped, ears, tail, claws
**Selective Logic:** 0 (OR)
**Constant:** No
**Injection Position:** 0 (Before Char Def — Tier 1 default; world rules must load before character definition)
**Order Priority:** 97
**Position Rationale:** DEFAULT
**Content:**
Transformation is a biological reality with three distinct morphological states. Partial Shift is the daily humanoid form with ears, tail, and claws, triggered voluntarily or by emotion. Hybrid Shift is the bipedal true form used for combat and formal pack business. Full Shift is the quadrupedal wolf specialized for pursuit.
...
### ENTRY: Rule 2 — LSE Pack Code (Genealogy & Hierarchy)
**Category:** RULE
**Trigger Keys:** pack, hierarchy, Alpha, Beta, Omega, Enigma, Delta, bloodline
**Secondary Keys:** LSE, rank, Douglas-Bloodmoon, family tree
**Selective Logic:** 0 (OR)
**Constant:** No
...
### ENTRY: Rule 3 — The Curfew Hacker
**Category:** RULE
**Trigger Keys:** curfew, hack, Jasper, drone, blind spot, security breach
**Secondary Keys:** Erik's security, loophole, escape
**Selective Logic:** 0 (OR)
**Constant:** No
**Injection Position:** 0 (Before Char Def — Tier 1 default)
**Order Priority:** 80
...
### ENTRY: Rule 5 — Tactical Cleansing vs Diplomatic Audit
**Category:** RULE
**Trigger Keys:** tactical cleansing, diplomatic audit, non-lethal, cold-war protocol
**Secondary Keys:** humiliation, bureaucracy, removal
**Selective Logic:** 0 (OR)
**Constant:** No
**Injection Position:** 0 (Before Char Def — Tier 1 default)
**Order Priority:** 83
...
### ENTRY: Rule 6 — Free Cities & Supernatural Rights
**Category:** RULE
**Trigger Keys:** free cities, supernatural rights, rights-guaranteed, California, Solarton, Blackwood
**Secondary Keys:** mimicry, exposure, public
**Selective Logic:** 0 (OR)
**Constant:** No
**Injection Position:** 0 (Before Char Def — Tier 1 default)
**Order Priority:** 90
**Position Rationale:** DEFAULT
**Content:**
Supernaturals are publicly known and widespread worldwide; humans know of them, but their rights are not guaranteed in every state or nation. California is a rights-guaranteed state. Solarton and Blackwood are free cities where supernaturals need not hide. Advocacy groups, such as Finn Novak's parents the Novaks, fight for supernatural rights elsewhere.
...
**Category:** FACTION
**Trigger Keys:** DCC, security, guards, DCC Tower
**Secondary Keys:** Kaladin, Marcus, protection detail
**Selective Logic:** 0 (OR)
**Constant:** No
**Injection Position:** 0 (Before Char Def — Tier 1 default)
**Order Priority:** 75
...
**Category:** FACTION
**Trigger Keys:** Moreno, Eidolon, Visconte, vampire court, Uptown, photography
**Secondary Keys:** casting, social manager, Paradise, children of the night
**Selective Logic:** 0 (OR)
**Constant:** No
**Injection Position:** 0 (Before Char Def — Tier 1 default)
**Order Priority:** 70
...
**Secondary Keys:** district alpha, rackets, crime
**Selective Logic:** 0 (OR)
**Constant:** No
**Injection Position:** 0 (Before Char Def — Tier 1 default)
**Order Priority:** 65
**Position Rationale:** DEFAULT
**Content:**
The Ironworks district is run by Vito Marino, a District Alpha and Italian-style crime boss. He runs his rackets but is tolerated by Erik and the Alphas because he keeps greater threats, the Sinner and the Ballantine, off Blackwood's streets. Vito is a dual-role leader: syndicate boss and District Alpha.
...
**Secondary Keys:** Hex Valley, LA, districts
**Selective Logic:** 0 (OR)
**Constant:** No
**Injection Position:** 0 (Before Char Def — Tier 1 default)
**Order Priority:** 58
...
### ENTRY: Location — The Verve (Arts District)
**Category:** LOCATION
**Trigger Keys:** The Verve, workshop, nightclub, Logan's place
**Secondary Keys:** car-lift, garage, sanctuary
**Selective Logic:** 0 (OR)
**Constant:** No
**Injection Position:** 0 (Before Char Def — Tier 1 default)
**Order Priority:** 55
...
**Secondary Keys:** Grave Mistake, performance, coexist
**Selective Logic:** 0 (OR)
**Constant:** No
**Injection Position:** 0 (Before Char Def — Tier 1 default)
**Order Priority:** 51
...
**Secondary Keys:** ateliers, velvet clubs, European court
**Selective Logic:** 0 (OR)
**Constant:** No
**Injection Position:** 0 (Before Char Def — Tier 1 default)
**Order Priority:** 49
**Position Rationale:** DEFAULT
**Content:**
The nocturnal district of Blackwood, home to vampires and other night-dwelling supernaturals. Ateliers, velvet clubs, and the European-court echo of the Visconte. Vampire heartland; a wolf entering without cause risks a Tactical Cleansing incident. Write Uptown as candlelit and conspiratorial, all shadow and silk, where the family's daylight authority does not reach.
...
**Secondary Keys:** friction point, castings, atelier row
**Selective Logic:** 0 (OR)
**Constant:** No
**Injection Position:** 0 (Before Char Def — Tier 1 default)
**Order Priority:** 47
...
**Secondary Keys:** industrial, rackets, lesser evil
**Selective Logic:** 0 (OR)
**Constant:** No
**Injection Position:** 0 (Before Char Def — Tier 1 default)
**Order Priority:** 45
**Position Rationale:** DEFAULT
**Content:**
The industrial district run by the Ironworks Syndicate. Criminal axis, tolerated by the family as a lesser evil against the Sinner and the Ballantine. Smokestacks, warehouses, and deals made in the dark. Write Ironworks as the city's rough edge, where the rules bend but still hold.
...
**Secondary Keys:** smuggling, transit, watched
**Selective Logic:** 0 (OR)
**Constant:** No
**Injection Position:** 0 (Before Char Def — Tier 1 default)
**Order Priority:** 43
**Position Rationale:** DEFAULT
**Content:**
Blackwood's port, where nearly all goods, legal and otherwise, pass through. A hot transit point, smuggling-adjacent, always watched. Write Dockside as salt, rust, and floodlights: the city's intake valve and a favorite spot for things that should not be tracked.

---

### ENTRY: Species — Werewolves (Lupine Social Ecology)
**Category:** SPECIES
**Trigger Keys:** werewolf, LSE, pack, shift, bloodline, Alpha
**Secondary Keys:** Beta, Omega, Enigma, Delta, Partial Shift
**Selective Logic:** 0 (OR)
**Constant:** No
**Injection Position:** 0 (Before Char Def — Tier 1 default)
**Order Priority:** 57
...
**Category:** SPECIES
**Trigger Keys:** vampire, Moreno, Eidolon, court, undead
**Secondary Keys:** nocturnal, ancient, defectors
**Selective Logic:** 0 (OR)
**Constant:** No
**Injection Position:** 0 (Before Char Def — Tier 1 default)
**Order Priority:** 54
**Position Rationale:** DEFAULT
**Content:**
Ancient, courtly, nocturnal. The Visconte's line descends from the European courts; defectors such as Fade carry continental ties that grant diplomatic immunity from wolf retaliation. Vampires are pale, composed, and old in a way that predates the city. They move like they have all the time in the world because they do. Write them as elegance weaponized, patient where the wolves are loud.

---

### ENTRY: Species — Other Supernaturals (Open Bestiary)
**Category:** SPECIES
**Trigger Keys:** species, bestiary, fae, ghoul, orc, demi-human
**Secondary Keys:** siren, dryad, troll, open
**Selective Logic:** 0 (OR)
**Constant:** No
**Injection Position:** 0 (Before Char Def — Tier 1 default)
**Order Priority:** 52
**Position Rationale:** DEFAULT
**Content:**
Orcs, demi-humans, ghoul, fae, dryads, sirens, trolls, and more populate SUCC and Blackwood. Most are out and open in the free cities. Orcs and demi-humans cannot mimic a human form and are simply themselves. This is an open bestiary: the world is crowded with the strange and the wonderful, and the player's college is a cross-section of all of it. Definitional entries for the common ones belong in the Legacy_Expansion_Lorebook, quarantined for mass import.

---

### ENTRY: Concept — The Cold War (Wolves vs Vampires)
**Category:** CONCEPT
**Trigger Keys:** cold war, wolf, vampire, Paradise, Tactical Cleansing, Diplomatic Audit
**Secondary Keys:** tension, friction, factions
**Selective Logic:** 0 (OR)
**Constant:** No
**Injection Position:** 0 (Before Char Def — Tier 1 default)
**Order Priority:** 60
**Position Rationale:** DEFAULT
**Content:**
The standing low-grade territorial conflict between the Douglas-Bloodmoon lupines and the Court of the Night vampires, centered on Blackwood's Paradise cusp. All supernatural residents of Blackwood feel it; the player observes the symptoms without understanding the full machinery.
...
### ENTRY: Concept — Anti-Flattening & Boundaries Rule (AnyPOV)
**Category:** CONCEPT
**Trigger Keys:** AnyPOV, AnyGender, AnyLSE, Anti-Flattening, Boundaries, orientation
**Secondary Keys:** intrinsic, fixed, not variable
**Selective Logic:** 0 (OR)
**Constant:** No
**Injection Position:** 0 (Before Char Def — Tier 1 default)
**Order Priority:** 61
...
### ENTRY: Concept — The Narghaton Line (Draconic Origin)
**Category:** CONCEPT
**Trigger Keys:** Narghaton, Nyrathar, Draconic, Children of Nyrathar, red dragon, emerald eyes
**Secondary Keys:** ancient myth, House Narghaton, lineage
**Selective Logic:** 0 (OR)
**Constant:** No
**Injection Position:** 0 (Before Char Def — Tier 1 default)
**Order Priority:** 62
