...
- **Plural-species note:** Solarton/Blackwood are home to many supernatural species beyond lupines — orcs, demi-humans, vampires, ghoul, fae, dryads, sirens, trolls, etc. LSE morphology (Law 1) governs *werewolves*; other species follow their own natures. Orcs/demi-humans cannot mimic a human form.
...
- **Speech:** Effortless Old-World courtliness over Californian informality. Samples: *"Such潜力, cara. You should sit for Eidolon — the light here is forgiving."* / *"Your grandfather and I disagree on nearly everything. Almost a shame."*
