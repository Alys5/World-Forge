...
### Angelo Moreno (Vampire Patriarch)
- **Role:** External antagonist, Vampire Patriarch (~1400 years old), Patron of Eidolon Creative
- **Core traits:** Charismatic predator, wants {{user}} in his sphere, FRENEMY with Wulfnic Bloodmoon
- **Voice:** Silk, ancient amusement, terrifying curiosity
...
### The Nine Firstborn / Last Three (LSE Core Canon)
#### Wulfnic Bloodmoon — The First Fang / The Builder King
- **Born:** ~827 AD, Iceland
- **Role:** Patriarch of House Bloodmoon, supreme political authority in North America
- **Profession:** Statesman
- **Niche:** Civilization Builder
- **Domains:** Leadership, Family, Territory, Justice, Civilization
- **Status:** Crossed to North America ~1025 AD, founded the Bloodmoon Dynasty
- **Relationship:** FRENEMY of Visconte Angelo Moreno
...
### Paradise District
- **Role:** Fashion district, cusp between Uptown and Seven Hills
- **Key feature:** Houses Eidolon Creative (Angelo's boutique and studio) at 100 Velvet Lane
- **Function:** Daily friction point of the cold war — Eidolon Creative's ateliers/castings live here, where wolf and vampire worlds brush constantly. One drop here triggers Tactical Cleansing or Diplomatic Audit.

### Uptown (Vampire Quarter)
- **Role:** Nocturnal district of Blackwood
- **Key features:** Vampires and other night-dwelling supernaturals, Ateliers, velvet clubs, European-court echo of the Visconte
- **Function:** Vampire heartland; a wolf entering without cause risks a Tactical Cleansing incident

### Oldtown
- **Role:** Old historical core of the city
- **Foundation:** Founded centuries ago by the Douglas dynasty when they settled here as colonial Governors migrating from England around 1600
- **Function:** Ancestral and historical root of Blackwood before modern expansion

### Dockside (The Port)
- **Role:** Blackwood's port
- **Function:** Hot transit point, smuggling-adjacent, always watched

### Arcadia & Clinica Vairë
- **Role:** Academic and medical district
- **Key features:** 
  - Arcadia: Scholarly oasis around the university campus
  - Clinica Vairë: Ultratmodern laboratory at 990 Helix Drive, Arcadia, Blackwood, CA
- **Function:** 
  - Arcadia: Where Prof. Helena Weiss cultivates psionic minds and new guardians
  - Clinica Vairë: Airen Vairë's domain, where neuroscience meets ancient magic for extreme anatomical and soul experiments

### Ironworks (Vito Marino's Turf)
- **Role:** Industrial, blue-collar neighborhood
- **Key feature:** Run by the Ironworks Syndicate
- **Function:** Criminal axis; tolerated by the family as a lesser evil against the Sinner/Ballantine

## Species Information (Additional Details)
...
### Werewolves (Lupine Social Ecology — LSE)
- **Note on plural-species:** Solarton/Blackwood are home to many supernatural species beyond lupines. LSE morphology (Rule 1) governs werewolves; other species follow their own natures. Orcs/demi-humans cannot mimic a human form.
...
- **Status:** Folded into SUCC Demographics world concept (Section 2f). They provide excellent background texture (e.g., a demon barista, a fae roommate) but do not need heavy mechanical entries that clutter the lore.

## World-Level Concepts (Additional Details)

### 101 Freeway Traffic Weapon
...
- **What it is:** Weres/Shapeshifters (25.8%), Demi-humans (24%), Humans (13.3%), Vampires (7.5%), Demons (5%), Fae (4.9%), Hybrids (4.7%), Undead (4%), Magic-capable Humans (4%), Other (<1%).
...
### From Brainstorm_Notes.md (Gaps the document doesn't fill):
...
### From Notes.md (Additional world details):
- **Location: City of Blackwood** - Population: ~250,000 (35% Humans, 65% Supernaturals)
...
- **The District Alphas:** [Listed in Blackwood.md]

### From old_scripts.js (Additional lore system details):
- The system uses a sophisticated lore book system with priority-based entry selection
- Features include text gates, tag gates, time gates, name blocks, probability systems, and shift mechanics
- Includes multi-message window processing for context awareness
- Has output formatting guards and normalization utilities