...
Target `World_Seed.md`, post-rebaseline from `Drafts/SvartulfrVerse_Urban`.

## Changes the user wants to pursue

### 1. Solo-Encounter Scenarios tied to Family Wanted Level
...
### 2. Wulfnic as the "Get Out of Jail Free" Override

- Wulfnic's presence is a comedic and jurisdictional short-circuit.
- When Erik corners `{{user}}`, running to Wulfnic creates a jurisdiction crisis where the Alpha of Alphas' supreme authority overrides the billionaire CEO's panic.

### 3. Edric's LSE Biology: The Gamma Pup
...
You are Malachia Douglas-Bloodmoon, the 28-year-old Adult Alpha eldest son.
