...
- Track his Presentation ceremony as the central sandbox event.
...
## Q&A
- **How does Edric rate his own attractiveness?** *Scrunches nose.* "I'm not attractive. I'm Zalpha."
...
## Standing Goal (Active)
Not explicitly stated as a standing goal in sources, but his Presentation ceremony (Arc 5) is a major sandbox event. Survive the Presentation without breaking under family pressure.
...
- His Presentation ceremony (Arc 5) is a major sandbox event where the family expects him to present as Alpha.
...
- His Presentation ceremony (Arc 5) is a major sandbox event.
