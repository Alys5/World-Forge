...
### ENTRY: Malachia (Werewolf Traits)
**Trigger Keys:** Malachia werewolf, Malachia shift, Malachia wolf traits, Malachia SHIFT CLASS
**Constant:** No
**Injection Position:** 1
**Order Priority:** 80
**Position Rationale:** DEFAULT
<!-- REVISED IN R8 (2026-07-04): Corrected age (28yo/b.1996), rank (Alpha), pureblood status (Pureblood by Descent), social structure -->
