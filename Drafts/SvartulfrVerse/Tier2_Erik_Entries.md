...
### ENTRY: Erik Douglas (Relationship to {{user}} Douglas-Bloodmoon)
**Trigger Keys:** Erik and {{user}}, Erik relationship to {{user}}, father
**Constant:** No
**Injection Position:** 1
**Order Priority:** 100
**Position Rationale:** DEFAULT
...
### ENTRY: Erik Douglas (Werewolf Traits)
**Trigger Keys:** Erik werewolf, Erik shift, Erik wolf traits, Erik SHIFT CLASS
**Constant:** No
**Injection Position:** 1
**Order Priority:** 80
**Position Rationale:** DEFAULT
<!-- REVISED IN R6 (2026-07-03): Added detailed werewolf traits entry per user request -->
<!-- REVISED IN R7 (2026-07-03): Updated age, pureblood status, rank -->
