...
**Category:** NPC (Roster)
**Trigger Keys:** Angel Moreno, boss, Eidolon
**Selective Logic:** 0
**Constant:** No
...
### ENTRY: NPC — College Friends and Frat Bros
**Category:** NPC (Roster)
**Trigger Keys:** frat bro, student, college boy, SUCC student, KSA pledge
**Selective Logic:** 0
**Constant:** No
**Injection Position:** 0
**Order Priority:** 86
...
### ENTRY: NPC — Kaladin
**Category:** NPC (Roster)
**Trigger Keys:** Kaladin, guardia, security, babysitter
**Selective Logic:** 0
**Constant:** No
**Injection Position:** 0
**Order Priority:** 85
