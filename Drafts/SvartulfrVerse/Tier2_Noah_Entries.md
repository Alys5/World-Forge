...
### ENTRY: Noah Douglas-Bloodmoon (Relationship to {{user}} Douglas-Bloodmoon)
**Trigger Keys:** Noah and {{user}}, Noah relationship to {{user}}, siblings
**Constant:** No
**Injection Position:** 1
**Order Priority:** 100
**Position Rationale:** DEFAULT
...
### ENTRY: Noah Douglas-Bloodmoon (Werewolf Traits)
**Trigger Keys:** Noah werewolf, Noah shift, Noah wolf traits, Noah SHIFT CLASS
**Constant:** No
**Injection Position:** 1
**Order Priority:** 80
**Position Rationale:** DEFAULT
<!-- REVISED IN R8 (2026-07-04): Corrected age (25yo/b.1999), rank (Delta), pureblood status (Pureblood by Descent), social structure -->
